    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('SiteAssistent', 'SiteAssistent'), ('ProjectIncharge', 'Project_Incharge')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customuser_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('category', models.CharField(choices=[('civil', 'civil'), ('electrical', 'electrical'), ('plumbing', 'plumbing')], max_length=100)),
